...
export const doctorDetailStyles = {
  ...
  // Form styles
  formContainer:
    "bg-white/80 backdrop-blur-sm border border-emerald-100 shadow-2xl p-6 sm:p-8 rounded-3xl mb-16",
  ...
  removeImageButton:
    "absolute -top-2 -right-1.5 bg-rose-500 text-white rounded-full p-1 transition",
  ...
  scheduleDateInput:
    "p-3 rounded-full border-2 border-emerald-100 w-full sm:w-auto",
  scheduleTimeSelect:
    "p-3 rounded-full border-2 border-emerald-100 w-full sm:w-auto",
  addSlotButton:
    "px-5 py-3 bg-emerald-500 text-white rounded-full flex items-center gap-2 w-full sm:w-auto justify-center",
  slotsGrid:
    "mt-4 space-y-2 max-w-9xl grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 lg:grid-cols-3 gap-4",
  slotItem:
    "flex justify-between items-center bg-emerald-50 p-3 rounded-xl border border-emerald-100 shadow-sm hover:shadow-md text-emerald-800",
  ...
  // Toast styles
  toastContainer:
    "fixed top-6 right-3 left-3 sm:right-6 sm:left-auto p-4 rounded-xl shadow-xl flex items-center gap-3",
...
export const pageStyles = {
  ...
  searchContainer:
    "flex items-center bg-white rounded-full px-3 py-2 shadow-sm w-full sm:w-72",
  searchIcon: "text-emerald-400",
  searchInput:
    "ml-3 w-full outline-none text-emerald-700 placeholder-emerald-400 bg-transparent text-sm",

  filterContainer:
    "flex items-center flex-col md:flex-row lg:flex-row gap-2 w-full sm:w-auto",
  dateFilter:
    "bg-white rounded-full px-3 py-2 shadow-sm flex items-center gap-2 w-full sm:w-auto",
  dateFilterIcon: "text-emerald-400",
  dateInput: "text-sm outline-none text-emerald-700 bg-transparent w-full",

  selectFilter:
    "text-sm px-3 py-2 cursor-pointer rounded-full bg-emerald-100 shadow-sm outline-emerald-300 w-full sm:w-auto",
  clearButton:
    "ml-0 sm:ml-2 px-3 cursor-pointer py-2 rounded-full bg-emerald-600 text-white text-sm shadow-sm hover:opacity-95 transition w-full sm:w-auto",

  loadingErrorContainer:
    "col-span-full text-center text-emerald-600 py-12 rounded-lg bg-white/60 border border-emerald-100",
  errorContainer:
    "col-span-full text-center text-rose-600 py-6 rounded-lg bg-white/60 border border-rose-100",
  noResultsContainer:
    "col-span-full text-center text-emerald-600 py-12 rounded-lg bg-white/60 border border-emerald-100",
  ...
  slotContainer:
    "inline-flex items-center gap-2 text-sm text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full",
  ...
  showMoreButton:
    "px-4 py-2 cursor-pointer rounded-full bg-white border border-emerald-200 shadow-sm hover:shadow-md transition",
};
...
export const dashboardStyles = {
  ...
  clearButton:
    "px-3 py-2 bg-green-500 text-white rounded-full shadow hover:bg-green-600",

  // Doctors table styles
  tableContainer: "bg-white rounded-2xl shadow overflow-hidden",
  tableHeader:
    "px-6 py-4 border-b border-green-50 flex items-center justify-between",
  ...
  tableRow:
    "group transform transition-all duration-200 hover:shadow-lg hover:-translate-y-1",
  ...
  mobileEarningsContainer:
    "mt-3 flex items-center justify-between text-sm text-slate-700",

  // Show more button styles
  showMoreContainer: "px-6 py-4 border-t border-green-50 flex justify-center",
  showMoreButton:
    "px-4 py-2 rounded-full bg-white border border-green-200 shadow-sm hover:bg-green-50 transition",
...
export const addServiceStyles = {
  ...
  buttons: {
    ...
    uploadImage:
      "flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white border border-emerald-200 hover:shadow transition-shadow",
    removeImage:
  ...
  imageUpload: {
    ...
    preview:
      "w-full h-56 rounded-xl overflow-hidden bg-white flex items-center justify-center border border-emerald-100",
  ...
  formFields: {
    ...
    select:
      "mt-2 w-full px-4 py-3 rounded-full border border-emerald-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    smallSelect:
      "mt-1 w-full px-3 py-2 rounded-full border border-emerald-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    timeSelect:
      "mt-1 w-full px-2 py-2 rounded-full border border-emerald-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
    ampmSelect:
      "mt-1 w-full px-1 py-2 rounded-full border border-emerald-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-emerald-200 focus:outline-none",
  },
  ...
  instructions: {
    ...
    input:
      "flex-1 min-w-0 px-3 py-2 rounded-full border border-emerald-100 focus:outline-none focus:ring-2 focus:ring-emerald-200",
  ...
  slots: {
    ...
    slotItem:
      "flex items-center gap-2 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-100 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
    slotText:
      "text-xs whitespace-nowrap xl:text-xs lg:text-xs lg:whitespace-nowrap xl:whitespace-nowrap font-medium max-w-[180px] sm:max-w-[300px] md:max-w-[320px]",
  },
  ...
  grids: {
    ...
    timeGrid:
      "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-3 mb-4",
    timeSubGrid: "grid grid-cols-3 gap-2 min-w-0",
    slotsGrid:
      "grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-1 overflow-auto gap-2 max-h-screen pr-2",
  },

  // Header action container
  headerActions:
    "flex w-full sm:w-auto flex-col sm:flex-row items-stretch sm:items-center gap-3",
...
export const doctorListStyles = {
  ...
  headerSearchContainer:
    "w-full sm:w-auto mt-3 sm:mt-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-3",
  searchBox:
    "flex items-center w-full sm:w-96 bg-white rounded-full px-3 py-2 shadow-sm",
  searchIcon: "text-emerald-400",
  searchInput:
    "ml-3 w-full outline-none text-emerald-700 placeholder-emerald-400 bg-transparent",
  clearButton:
    "px-3 py-2 cursor-pointer rounded-full bg-emerald-600 text-white shadow hover:opacity-95 transition w-full sm:w-auto",
  ...
  gridContainer:
    "max-w-6xl grid xl:grid-cols-2 lg:grid-cols-2 lg:gap-3 xl:gap-4 mx-auto space-y-4",

  article:
    "bg-linear-to-r from-emerald-100/50 to-white rounded-2xl shadow-md border border-emerald-100 overflow-hidden transition-all duration-300",
  articleContent:
    "flex flex-col sm:flex-row items-start sm:items-center gap-4 p-3 sm:p-4 md:p-5",

  doctorImage:
    "w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover border border-emerald-200 shadow-sm mx-auto sm:mx-0",

  doctorInfoContainer: "flex-1 min-w-0 w-full",
  doctorHeader:
    "flex flex-col sm:flex-row sm:items-start items-start justify-between gap-3 w-full",
  doctorName:
    "text-base sm:text-lg md:text-xl text-emerald-800 font-medium truncate",
  ...
  statsContainer:
    "mt-3 flex flex-col sm:flex-row items-start sm:items-center gap-3",
  statsLabel: "text-xs text-emerald-500",
  statsValue: "text-sm text-emerald-700 font-medium flex items-center gap-2",

  actionContainer:
    "w-full sm:w-auto flex items-center justify-between sm:justify-end gap-2",
  deleteButton:
    "px-3 py-1 cursor-pointer rounded-full bg-red-50 text-red-600 text-xs flex items-center gap-2 transition",
  ...
  scheduleSlot:
    "text-xs px-3 py-1 rounded-full border border-emerald-100 shadow-sm break-words",

  statsSidebar:
    "col-span-1 flex flex-col sm:flex-row md:flex-col xl:flex-col lg:flex-col gap-3 items-start md:items-end",
  statsItemHeading: "text-md text-emerald-700 font-bold",
  statsItemValue: "text-sm text-emerald-700",
  locationValue:
    "text-sm sm:whitespace-nowrap whitespace-normal text-emerald-700",

  showMoreButton:
    "px-5 py-2 cursor-pointer rounded-full bg-white border border-emerald-300 shadow-sm hover:shadow-md transition",
...
export const navbarStyles = {
  ...
  glowEffect:
    "glow relative rounded-3xl p-1 bg-linear-to-r from-emerald-100 via-emerald-200 to-emerald-100",
  centerNavInner: "relative flex items-center",
  centerNavScrollContainer:
    "center-inner relative whitespace-nowrap rounded-3xl bg-white/95 lg:px-2 px-4 py-2 flex items-center gap-2 shadow-lg border border-gray-100 overflow-x-auto",
  ...
  signOutButton:
    "hidden lg:mx-1 lg:text-xs whitespace-nowrap xl:mx-1 lg:-mr-6 xl:mr-5 lg:flex px-4 py-2 cursor-pointer rounded-full bg-amber-500 text-white text-sm items-center gap-2 shadow-sm",
  loginButton:
    "px-3 py-2 cursor-pointer rounded-full border bg-white text-emerald-600 text-sm shadow-sm",
  ...
  mobileSignOutButton:
    "w-full py-2 rounded-full border bg-amber-500 text-white font-medium",
  mobileLoginButton:
    "w-full cursor-pointer py-2 rounded-full border bg-white text-emerald-600 font-medium",

  // Indicator (for active navigation)
  indicator:
    "absolute bottom-0 left-0 h-0.5 bg-emerald-400 transition-all duration-300 ease-out rounded-full",
...
export const heroStyles = {
  ...
  // Content container
  contentBox:
    "bg-white/90 backdrop-blur-sm border border-emerald-100 rounded-3xl shadow-xl p-8 md:p-12 text-center",
...
export const serviceListStyles = {
  // Layout styles
  pageContainer:
    "p-4 sm:p-6 max-w-6xl font-serif mx-auto min-h-screen bg-linear-to-b from-green-50 via-white to-white",
  ...
  filterContainer:
    "flex flex-col md:flex-col items-stretch md:items-center gap-3 w-full md:w-auto",
  filterButtonsContainer:
    "inline-flex flex-wrap items-center gap-2 rounded-full border border-emerald-100 bg-white p-1",
  ...
  searchInput:
    "pl-12 pr-4 py-2 rounded-full border border-emerald-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 transition w-full md:w-72 bg-white",

  // Grid styles
  servicesGrid:
    "grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-6",

  // Service card styles
  serviceCard:
    "bg-white rounded-2xl overflow-hidden transform transition hover:-translate-y-1 hover:shadow-2xl border border-emerald-50",
  serviceCardContent:
    "flex flex-col sm:flex-row sm:items-start gap-4 p-4 cursor-pointer",
  serviceImageContainer:
    "w-full sm:w-20 h-40 sm:h-20 rounded-lg overflow-hidden bg-emerald-50 ring-1 ring-emerald-50 flex-shrink-0",
  serviceImage: "w-full h-full object-cover",
  serviceImagePlaceholder:
    "w-full h-full flex items-center justify-center text-emerald-300",
  ...
  availabilityBadge:
    "text-xs mt-1 inline-flex items-center gap-1 px-2 py-1 rounded-full",
  ...
  editImagePreview:
    "w-full sm:w-36 h-36 rounded-lg overflow-hidden bg-emerald-50 ring-1 ring-emerald-50 flex-shrink-0",
  editFormFields: "flex-1 space-y-2",
  inputBase:
    "w-full border rounded-lg px-3 py-2 outline-none transition focus:ring-2 focus:ring-green-200 focus:border-green-300 border-green-100 bg-white",
  availabilitySelectContainer: "mt-1 flex items-center gap-2",
  availabilityLabel: "text-sm text-emerald-600",
  availabilitySelect:
    "border rounded-full cursor-pointer px-3 py-1 outline-none focus:ring-2 focus:ring-emerald-200 border-emerald-300",
  fileInputContainer: "mt-2",
  fileInputLabel: "text-sm block mb-1 text-emerald-700",
  fileInput:
    "w-full border border-emerald-300 rounded-full px-4 py-2 text-sm bg-white cursor-pointer file:bg-emerald-50 file:border-0 file:px-4 file:py-1 file:rounded-full file:text-emerald-700 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-200 transition",
  textarea: "min-h-[68px]",
  ...
  addSlotButton:
    "inline-flex cursor-pointer items-center gap-2 text-sm px-2 py-1 rounded-full border border-emerald-100",
  slotsContainer: "space-y-2 mt-2",
  slotRow: "flex flex-col sm:flex-row sm:items-center gap-2 w-full",
  slotDateInput:
    "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-emerald-200 border-emerald-100 w-full sm:w-auto",
  slotTimeContainer: "flex gap-2 items-center w-full sm:w-auto",
  slotSelect:
    "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-emerald-200 border-emerald-100 w-20",
  removeSlotButton:
    "px-2 py-1 rounded-full cursor-pointer border-red-500 bg-red-300 border text-sm text-black",

  // Form action buttons
  formActions: "flex flex-col sm:flex-row items-center gap-2 justify-end",
  cancelButton:
    "px-3 py-2 rounded-full cursor-pointer border-red-600 bg-red-300 border w-full sm:w-auto",
  saveButton:
    "px-3 py-2 rounded-full cursor-pointer bg-emerald-600 text-white w-full sm:w-auto",
  ...
  instructionsList:
    "list-disc list-inside text-md text-emerald-500 mt-1 space-y-1",
  ...
  editButton:
    "inline-flex bg-emerald-200 cursor-pointer items-center gap-2 px-3 py-2 rounded-full border border-emerald-300",
  removeButton:
    "inline-flex items-center bg-red-200 cursor-pointer gap-2 px-3 py-2 rounded-full border text-rose-600",
...
export const serviceAppointmentsStyles = {
  ...
  searchInput:
    "pl-10 pr-10 w-full rounded-full border border-emerald-200 bg-white/90 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 transition-all",
  clearSearchButton: "absolute right-3 rounded-full p-1 hover:bg-gray-100",
  clearSearchIcon: "w-4 h-4 text-gray-500",

  statusFilterSelect:
    "text-sm px-3 py-2 cursor-pointer rounded-full border border-emerald-400",
  ...
  loadingContainer:
    "col-span-full rounded-2xl p-8 bg-white/90 border border-emerald-50 shadow-sm flex items-center justify-center gap-3",
  errorContainer:
    "col-span-full rounded-2xl p-4 bg-rose-50 border border-rose-100 text-rose-700",

  noResultsContainer:
    "col-span-full rounded-2xl p-8 bg-white/90 border border-emerald-50 shadow-sm flex items-center justify-center flex-col gap-3",
  noResultsIcon: "text-3xl text-emerald-300",
  noResultsText: "text-sm text-gray-600",
  noResultsSubtext: "text-xs text-gray-400",

  gridContainer:
    "grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-stretch",

  article:
    "group relative rounded-3xl p-1 animated-border h-full transform transition-all duration-300 hover:-translate-y-2",
  cardInner:
    "card-inner rounded-2xl overflow-hidden border-2 border-emerald-300/60 p-5 bg-white/90 shadow-lg h-full flex flex-col justify-between",
  ...
  patientAvatar:
    "rounded-full w-12 h-12 flex items-center justify-center bg-emerald-100/70",
  patientAvatarIcon: "h-6 w-6 text-emerald-700",
  patientInfo: "min-w-0",
  patientName:
    "text-lg md:text-sm lg:text-xs xl:text-md whitespace-nowrap font-bold leading-tight text-emerald-900 w-full line-clamp-2",
  ...
  legendContainer:
    "mt-6 p-4 rounded-lg bg-white/80 shadow-inner border border-emerald-100 text-sm flex flex-col sm:flex-row flex-wrap items-center gap-4",
  ...
  rescheduleEditContainer:
    "flex flex-col sm:flex-row xl:flex-col md:flex-col md:items-end gap-2 bg-gray-50 p-2 rounded-md shadow-sm",
  rescheduleDateInput:
    "text-sm px-3 py-1 w-full sm:w-auto text-green-800 border border-emerald-500 rounded-full",
  rescheduleTimeInput:
    "text-sm px-3 py-1 w-full sm:w-auto text-green-800 border border-emerald-500 rounded-full",
  rescheduleActions: "flex gap-2 w-full sm:w-auto",
  rescheduleSaveButton:
    "flex-1 sm:flex-none px-3 py-1 bg-green-500 cursor-pointer text-white border-emerald-500 rounded-full text-sm",
  rescheduleCancelButton:
    "flex-1 sm:flex-none px-3 py-1 bg-red-200 border text-sm cursor-pointer border-red-500 rounded-full",

  // Toast component styles
  toastContainer: "fixed top-4 right-3 sm:right-4 z-50 flex flex-col gap-3",
  toast:
    "max-w-xs w-full rounded-lg shadow-lg px-4 py-3 border-l-4 border-emerald-400 bg-white/95 backdrop-blur-sm",
  toastContent: "flex items-start gap-3",
...
export const serviceDashboardStyles = {
  // Container styles
  container:
    "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-b from-emerald-50 via-emerald-25 to-white",
  innerContainer: "max-w-7xl mx-auto",

  // Header styles
  header: {
    container:
      "flex flex-col sm:flex-row items-start sm:items-center md:items-center justify-between mb-6 gap-3 md:gap-6 lg:gap-3",
  ...
  search: {
    ...
    inputContainer:
      "flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-emerald-200 w-full sm:w-64",
  ...
  table: {
    container:
      "bg-white rounded-2xl shadow-sm overflow-hidden border-b border-transparent",
    headerMd:
      "hidden md:grid lg:hidden grid-cols-5 items-center gap-6 px-4 py-3 text-sm text-gray-600 bg-emerald-50",
    headerLg:
      "hidden lg:grid md:text-xs lg:text-xs xl:text-md grid-cols-12 items-center gap-4 px-4 py-3 text-sm text-gray-600 bg-emerald-50",
    ...
    tabletImage:
      "w-10 h-10 rounded-lg overflow-hidden bg-gray-200 ring-1 ring-emerald-100",
    ...
    desktopImage:
      "w-16 h-16 rounded-xl overflow-hidden ring-1 ring-emerald-100 bg-gray-200",
    desktopServiceName:
      "font-semibold md:text-xs lg:text-lg xl:text-lg text-emerald-800",
    ...
    mobileImage:
      "w-14 h-14 rounded-lg overflow-hidden bg-gray-200 ring-1 ring-emerald-100",
